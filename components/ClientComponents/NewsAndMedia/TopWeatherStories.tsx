    ...
    return (
        <div ref={idRef}>
            ...
            <div className="flex justify-between items-center mb-6 mt-8">
                ...
                <button onClick={() => setCurrentPageItems(parsedNews?.length)} className="leading-[130%] text-[#4A4C56] md:text-base text-sm font-normal md:py-[13.5px] py-[8px] md:px-[20px] px-4 bg-[] rounded-[4px] bg-white cursor-pointer shadow-[0 0 20px 0 rgba(19, 142, 255, 0.10)] hover:bg-[#0080C4] hover:text-white duration-200">
                    View All
                </button>
            </div>
            <div>
