...
const SevereWeatherFeed = () => {
    ...
    const { data, loading, error } = useRSSFeed(RSS_LATEST_WEATHER_FEEDS?.extremeWeather)
    ...
    return (
        <div className="" ref={idRef} >
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="lg:text-[32px] md:text-[28px]  text:2xl leading-[130%] font-bold text-[#4A4C56] py-[3px]">Extreme Weather News</h1>
...
export default SevereWeatherFeed;